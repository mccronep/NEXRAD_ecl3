...
dashs='-s'
dashb='-b'
# the dashb Added by pmccrone 11/8/23
dashd='-d'
rpgaa='rpga1'

# I added the dashb at the beginning. Note: I am uncerain if it matters.
popen_list=[cmd_spec, dashb, dashp, port_num, dasha, dashs,rad_site, dashd, output_dir, rpgaa]

#rpsfile='qpetest_rps_list.ISDP_B22.dat'
# RPS List was changed by PJM on Apr 17 2024
rpsfile='tda_test_rps_list_a.dat'  
#'qpetest_midi_rps_list.dat'
creturn='\n'
